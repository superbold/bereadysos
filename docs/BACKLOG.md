...
3. [x] **Mobile shopping list** — Phone-as-list on Restock while `shopping`: large check-off, qty steppers, progress, sticky Done; persists via `update_shop_run_line_shopping`.
